...
[verse]
// tag::synopsis[]
aerospace list-workspaces [-h|--help] --monitor <monitor>... [--visible [no]] [--empty [no]] [--format <output-format>] [--count] [--json] [--include-scratchpads]
aerospace list-workspaces [-h|--help] --all [--format <output-format>] [--count] [--json] [--include-scratchpads]
aerospace list-workspaces [-h|--help] --focused [--format <output-format>] [--count] [--json] [--include-scratchpads]
...
--include-scratchpads::
Include scratchpad workspaces in the output (they are excluded by default).
